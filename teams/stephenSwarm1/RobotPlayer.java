...
//				scaleCohesion = 3.0 * maxEnergon/energon;
//				scaleSeparation = 10.0 * energon/maxEnergon;
				...
				/////////////////////////CHARGE SPAWNED UNIT////////////////////
                while(Clock.getRoundNum()-spawnTime < 200 && spawnTime!=0 && rc.getRobotType()==RobotType.ARCHON){
                	energy.chargeSpawnedUnit(rc.getLocation().add(rc.getDirection()));
                	rc.yield();
                }
                energy.transferEnergon();
				...
				if(num<30){
					...
					if(rc.getRobotType() == RobotType.ARCHON && rc.getEnergonLevel()>15.0){
