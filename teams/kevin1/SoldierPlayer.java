...
public class SoldierPlayer extends BasePlayer {
	Random rand;
	public SoldierPlayer(RobotController r) {
		super(r);
		rand = new Random(0);
	}
	...
	/**
	 * Searches for enemy units near the soldier and attacks the first one it sees and can attack. (air first then ground)
	 */
	public void fire(){
		try {
