...
public class SpawnWoutGoal extends Goal {
	Filter nearbyWouts;
	public SpawnWoutGoal(BasePlayer player) {
		super(player);
		initFilters();
	}
	...
	public boolean takeControl() {
		...
		Set<Robot> nearby = nearbyWouts.filter(myIntel.getNearbyGroundRobots());
	...
	public void initFilters(){
		nearbyWouts = FilterFactory.typeTeamRangeFilter(myRC, myIntel, RobotType.WOUT, 
